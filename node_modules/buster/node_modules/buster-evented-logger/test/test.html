...
<html lang="en">
  <head>
    <title>buster-evented-logger</title>
  ...
  <body>
    ...
    <script src="../node_modules/json/json2.js"></script>
    ...
    <script src="../lib/buster-evented-logger.js"></script>
    <script src="../test/buster-evented-logger-test.js"></script>
  </body>
</html>
